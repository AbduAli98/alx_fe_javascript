...
function populateCategories() {
  ...
  if ([...categorySelect.options].some(o => o.value === saved)) {
...
function addQuote() {
  ...
  if (text !== "" && category !== "") {
    ...
    const prevFilter = categorySelect.value;
    populateCategories();

    if (prevFilter === "all" || prevFilter === category) {
      categorySelect.value = (prevFilter === "all") ? "all" : category;
    }
    filterQuotes();           
